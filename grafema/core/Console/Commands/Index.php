...
use Grafema\Console\Terminal;
use Grafema\I18n;
use Grafema\Console\Command;
use Grafema\Console\Styles\TextColor;
...
class Index extends Command
{
    ...
    protected string $description = 'Shows full list of Grafema CLI commands.';
	...
	public function handle() : void
    {
		...
		$version = GRFM_VERSION;
		$year    = date('Y');

	    $this->info("[green]#$text#Program version: [green]#$version# | © 2024-$year «grafema.com»".PHP_EOL);
