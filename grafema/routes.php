...
try {
	...
	Route::any( $dashboardRoute, function( $slug ) use ( $dashboardSlug ) {
		 ...
		 * @since 2025.1
		 */
		require_once GRFM_DASHBOARD . 'app/index.php';
		 ...
		 * @since 2025.1
		 */
		echo Hook::call( 'grafema_dashboard_loaded', $content, $slug );
	});
