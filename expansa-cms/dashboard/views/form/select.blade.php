	...
	<?php if ( $label ) : ?>
		<div class="<?php echo $label_class; ?>"><?php
			...
			if ( $reset ) :
				...
				?>
				<span class="ml-auto t-red" @click="<?php echo $click; ?>" u-show="<?php echo $show; ?>" u-cloak><?php echo t( 'Reset' ); ?></span>
				<?php
			endif;
			$tooltip && printf( ' <i class="ph ph-info" u-tooltip.click.prevent="\'%s\'"></i>', $tooltip );
			?>
		</div>
	<?php endif; ?>
