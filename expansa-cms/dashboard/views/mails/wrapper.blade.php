...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=<?php echo Options::get( 'charset' ); ?>">
...
<table border="0" cellpadding="0" cellspacing="0"
       style="width: 90%; max-width: 560px; margin: 0 auto; background: #fff; border-radius: 4px; overflow: hidden; border: 1px solid #e6e7e9; border-top: 4px solid #206bc4;">
    <tr>
        <?php echo view($template, $__data); ?>
    </tr>
</table>
<table border="0" cellpadding="10" cellspacing="0"
       style="width: 90%; max-width: 560px; padding: 20px 0 0; margin: 0 auto;">
    <tbody>
    <tr>
