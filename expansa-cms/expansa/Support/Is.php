...
final class Is
{
     ...
     * points to the admin part. Does not check whether the user is authorized or whether the user has
     * access to the requested page. Is designed just to check the location in the admin panel and is
     * not intended to protect requests. For checking roles and capabilities, use `User` class.
     *
     * @return bool true if inside Expansa administration interface, false otherwise.
     */
