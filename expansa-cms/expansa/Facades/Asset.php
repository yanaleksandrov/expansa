 ...
 *
 * @method static void  enqueue(string $uid, string $src, string $type, ...$data)
 * @method static void  style(string $uid, string $src, ...$data)
 * @method static void  script(string $uid, string $src, ...$data)
 ...
 * @method static void  render(array $filter = [])
