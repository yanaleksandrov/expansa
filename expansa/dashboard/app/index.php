 ...
 * @since 2025.1
 */
new class extends \Expansa\App\App {
	...
	public function __construct() {
		 ...
		 * @since 2025.1
		 */
		$this->define( 'EX_IS_DASHBOARD', true );
		...
		$styles  = ['phosphor'];
		if ( ! Is::install() ) {
			$styles  = ['phosphor', 'air-datepicker', 'colorist', 'datepicker', 'drooltip', 'slimselect', 'dialog', 'expansa', 'controls', 'utility', 'notifications', 'nav-editor'];
		}
