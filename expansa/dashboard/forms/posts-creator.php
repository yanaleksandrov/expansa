		...
		echo Dashboard\Form::build(
			[
				...
				[
					...
					'label_class' => '',
					'reset'       => 0,
					'before'      => I18n::_t( '%sFrom:%s', '<samp class="badge badge--blue-lt">', '</samp>' ),
					'after'       => '',
					'instruction' => '',
					'tooltip'     => '',
					'copy'        => 0,
					...
					'conditions'  => [],
					'attributes'  => [
						'placeholder' => I18n::_t( 'e.g. Just another Expansa site' ),
					],
				],
				[
					'type'        => 'date',
					...
					'label_class' => '',
					'reset'       => 0,
					'before'      => I18n::_t( '%sTo:%s', '<samp class="badge badge--blue-lt">', '</samp>' ),
					'after'       => '',
					'instruction' => '',
					'tooltip'     => '',
					'copy'        => 0,
