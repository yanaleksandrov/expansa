...
class Headers extends CaseInsensitiveDictionary {
	 ...
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed argument is not valid as an array key.
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed argument is not a string or an array.
	 */
