...
final class Http implements Proxy {
	 ...
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed argument is not an array, a string or null.
	 * @throws \Expansa\Http\Exception\ArgumentCount On incorrect number of arguments (`proxyhttpbadargs`)
	 */
	 ...
	 *
	 * @since 1.6
	 * @see \Expansa\Http\Proxy\Http::curl_before_send()
	 * @see \Expansa\Http\Proxy\Http::fsockopen_remote_socket()
	 * @see \Expansa\Http\Proxy\Http::fsockopen_remote_host_path()
	 * @see \Expansa\Http\Proxy\Http::fsockopen_header()
