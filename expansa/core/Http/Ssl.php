...
final class Ssl {
	 ...
	 * @return bool
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $host argument is not a string or a stringable object.
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $cert argument is not an array or array accessible.
	 */
	 ...
	 * @throws \Expansa\Http\Exception\InvalidArgument When either of the passed arguments is not a string or a stringable object.
	 */
