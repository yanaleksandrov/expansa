...
class Jar implements ArrayAccess, IteratorAggregate {
	 ...
	 *
	 * @param string|\Expansa\Http\Cookie $cookie Cookie header value, possibly pre-parsed (object).
	 * @param string                        $key    Optional. The name for this cookie.
	 * @return \Expansa\Http\Cookie
	 */
	 ...
	 *
	 * @param \Expansa\Http\Contracts\HookManager $hooks Hooking system
	 */
	 ...
	 *
	 * @param \Expansa\Http\Response $response Response as received.
	 */
