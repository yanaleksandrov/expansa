 ...
 */
	 ...
	 *
	 * @param \Expansa\Http\Iri $uri URI to check
	 ...
	 * @return \Expansa\Http\Cookie Parsed cookie object
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $cookie_header argument is not a string.
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $name argument is not a string.
	 */
	 ...
	 *
	 * @param \Expansa\Http\Response\Headers $headers Headers to parse from
	 * @param \Expansa\Http\Iri|null         $origin  URI for comparing cookie origins
	 * @param int|null                         $time    Reference time for expiration calculation
	 * @return array
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $origin argument is not null or an instance of the Iri class.
	 */
