...
class Session {
	...
	/**#@+
	 * @see \Expansa\Http\Session::request()
	 * @param string $url
	 * @param array $headers
	 * @param array $options
	 ...
	 *
	 * @see \Expansa\Http\Requests::request_multiple()
	 *
	 * @param array $requests Requests data (see {@see \Expansa\Http\Requests::request_multiple()})
