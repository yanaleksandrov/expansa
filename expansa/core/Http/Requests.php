...
class Requests {
	 ...
	 * Option defaults.
	 *
	 * @see \Expansa\Http\Requests::get_default_options()
	 * @see \Expansa\Http\Requests::request() for values returned by this method
	 *
	 * @since 2.0.0
	 *
	 * @var array
	 ...
	 *
	 * Use {@see \Expansa\Http\Requests::get_transport()} instead
	 *
	 * @var array
	 */
	 ...
	 *
	 * @see \Expansa\Http\Requests::get_certificate_path()
	 * @see \Expansa\Http\Requests::set_certificate_path()
	 *
	 * @var string
	 */
	 ...
	 *
	 * @param array<string, bool> $capabilities Optional. Associative array of capabilities to test against, i.e. `['<capability>' => true]`.
	 * @return \Expansa\Http\Contracts\Transport
	 * @throws \Expansa\Http\Exception If no valid transport is found (`notransport`).
	 */
	 ...
	 * Supported capabilities can be found in the {@see \Expansa\Http\Contracts\Capability}
	...
	/**#@+
	 * @see \Expansa\Http\Requests::request()
	 * @param string $url
	 * @param array $headers
	 * @param array $options
	 ...
	 *
	 * Note: Unlike {@see \Expansa\Http\Requests::post()} and {@see \Expansa\Http\Requests::put()},
	 ...
	 *    {@see \Expansa\Http\Requests::getTransport()}
	 *    (string|\Expansa\Http\Transport, default: {@see \Expansa\Http\Requests::getTransport()})
	 * - `hooks`: Hooks handler.
	 ...
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $type argument is not a string.
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $options argument is not an array.
	 * @throws \Expansa\Http\Exception On invalid URLs (`nonhttp`)
	 */
	 ...
	 *    parameter to {@see \Expansa\Http\Requests::request()}
	 *    (array, default: `array()`)
	 * - `data`: Associative array of data fields or a string. Same as the
	 *    `$data` parameter to {@see \Expansa\Http\Requests::request()}
	 *    (array|string, default: `array()`)
	 * - `type`: HTTP request type (use \Expansa\Http\Requests constants). Same as the `$type`
	 *    parameter to {@see \Expansa\Http\Requests::request()}
	 *    (string, default: `\Expansa\Http\Requests::GET`)
	 * - `cookies`: Associative array of cookie name to value, or cookie jar.
	 *    (array|\Expansa\Http\Cookie\Jar)
	 *
	 * If the `$options` parameter is specified, individual requests will
	 * inherit options from it. This can be used to use a single hooking system,
	 * or set all the types to `\Expansa\Http\Requests::POST`, for example.
	 *
	 * In addition, the `$options` parameter takes the following global options:
	 *
	 * - `complete`: A callback for when a request is complete. Takes two
	 *    parameters, a \Expansa\Http\Response/\Expansa\Http\Exception reference, and the
	 ...
	 * @return array Responses (either \Expansa\Http\Response or a \Expansa\Http\Exception object)
	 *
	 ...
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed $url argument is not a string, Stringable or boolean.
	 */
	 ...
	 * @return void
	 *
	 * @throws \Expansa\Http\Exception When the $url is not an http(s) URL.
	 */
	 ...
	 * @return \Expansa\Http\Response
	 *
	 * @throws \Expansa\Http\Exception On missing head/body separator (`requests.no_crlf_separator`)
	 * @throws \Expansa\Http\Exception On missing head/body separator (`noversion`)
	 * @throws \Expansa\Http\Exception On missing head/body separator (`toomanyredirects`)
	 */
	 ...
	 *
	 * Internal use only. Converts a raw HTTP response to a \Expansa\Http\Response
	 * while still executing a multiple request.
	 *
	 * `$response` is either set to a \Expansa\Http\Response instance, or a \Expansa\Http\Exception object
	 *
	 * @param string $response Full response text including headers and body (will be overwritten with Response instance)
	 * @param array  $request  Request data as passed into {@see \Expansa\Http\Requests::request_multiple()}
	 * @return void
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed argument is not iterable.
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed argument is not a string.
	 */
