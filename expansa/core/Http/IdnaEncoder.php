...
class IdnaEncoder {
	 ...
	 * @throws \Expansa\Http\Exception\InvalidArgument When the passed argument is not a string or a stringable object.
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception Provided string longer than 64 ASCII characters (`idna.provided_too_long`)
	 * @throws \Expansa\Http\Exception Prepared string longer than 64 ASCII characters (`idna.prepared_too_long`)
	 * @throws \Expansa\Http\Exception Provided string already begins with xn-- (`idna.provided_is_prefixed`)
	 * @throws \Expansa\Http\Exception Encoded string longer than 64 ASCII characters (`idna.encoded_too_long`)
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception Invalid UTF-8 codepoint (`idna.invalidcodepoint`)
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception On character outside of the domain (never happens with Punycode) (`idna.character_outside_domain`)
	 */
	 ...
	 *
	 * @throws \Expansa\Http\Exception On invalid digit (`idna.invalid_digit`)
	 */
