...
use Expansa\DatabaseLegacy\Contracts\ConnectionResolver;
...
class DatabaseManager implements ConnectionResolver
{
    ...
    protected array $drivers = [
        'mysql'  => [
            'connection' => \Expansa\DatabaseLegacy\Drivers\MySQL\Connection::class,
            'connector'  => \Expansa\DatabaseLegacy\Drivers\MySQL\Connector::class,
        ],
        'pgsql'  => [
            'connection' => \Expansa\DatabaseLegacy\Drivers\Postgres\Connection::class,
            'connector'  => \Expansa\DatabaseLegacy\Drivers\Postgres\Connector::class,
        ],
        'sqlite' => [
            'connection' => \Expansa\DatabaseLegacy\Drivers\SQLite\Connection::class,
            'connector'  => \Expansa\DatabaseLegacy\Drivers\SQLite\Connector::class,
        ],
    ];
